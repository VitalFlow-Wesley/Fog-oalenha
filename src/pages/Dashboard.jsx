...
export default function Dashboard({ tables }) {
  ...
  const statCards = [
    ...
    },
    {
      title: 'Em consumo',
      value: money(total),
      detail: 'Total das comandas abertas',
      icon: DollarSign,
      tone: 'gold',
      watermark: '▤',
    },
    {
      ...
      value: kitchenSent,
      detail: 'Pedidos já mandados para cozinha',
      icon: ChefHat,
      tone: 'orange',
      watermark: '⚔',
    },
    ...
    <div className="page operationDashboardPage">
      <div className="dashboardHeader">
        ...
        <div className="dashboardActions">
          <button className="dateSelect" type="button">
            <CalendarDays size={18} />
            Hoje
            <span>⌄</span>
          </button>
          <button className="dashboardRefresh" type="button">
            <RefreshCw size={18} />
            Atualizar
          </button>
        </div>
      ...
      <div className="dashboardMainGrid">
        <section className="dashboardPanel kitchenPanelPremium">
          ...
          <button className="viewAllOrders" type="button">Ver todos os pedidos ›</button>
        </section>
        ...
        <aside className="dashboardPanel operationalPanel">
          ...
          <div className="operationalList">
            ...
            <div className="operationalItem orange">
              ...
              <div>
                <span>Tempo médio dos pedidos</span>
          ...
          <div className="operationMessage">
            <ShieldCheck size={18} />
            Tudo funcionando bem! Mantenha o ritmo!
          </div>
        </aside>
      </div>
    </div>
