...
export default function Usuarios({ users, setUsers, tables, setTables, currentUser, settings, setSettings }) {
  ...
  // --- MOTOR DE IMPRESSÃO ESC/POS SANITIZADO ---
  async function executeThermalPrint(targetPrinterName, logLabel) {
    try {
      ...
      // 2. Motor de Assinatura Sanitizado contra caracteres fantasmas do Bloco de Notas
      qz.security.setSignaturePromise((toSign) => {
        return async (resolve, reject) => {
          try {
            ...
            // Purifica a chave eliminando qualquer whitespace invisivel gerado na transferencia
